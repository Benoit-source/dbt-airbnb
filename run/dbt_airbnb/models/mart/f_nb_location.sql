  ...
  create or replace   view AIRBNB_BI.BI_GOLD.f_nb_location
...
price as (
    ...
    TR_PRICE 
    from AIRBNB_BI.BI_SILVER.int_d_price
...
town as (
    ...
    from AIRBNB_BI.BI_SILVER.int_d_town
...
room as (
    ...
    from AIRBNB_BI.BI_SILVER.int_d_type_room
