  ...
  create or replace   view AIRBNB_BI_PROD.BI_BRONZE.stg_airbnb__review_S_1
...
(
  ...
  as (
    ...
    from AIRBNB_BI_PROD.RAW_AIRBNB_BORDEAUX.DBO_REVIEW
...
airbnb_lyon as (
    ...
    from AIRBNB_BI_PROD.RAW_AIRBNB_LYON.AIRBNB_REVIEW
    Where Date = To_Date('16/06/2025','DD/MM/YYYY')
),
...
airbnb_paris as (
    ...
    from AIRBNB_BI_PROD.RAW_AIRBNB_PARIS.AIRBNB_REVIEW
    Where Date = To_Date('16/06/2025','DD/MM/YYYY')
),
...
airbnb_pays_basque as (
    ...
    from AIRBNB_BI_PROD.RAW_AIRBNB_PAYS_BASQUE.AIRBNB_REVIEW
    Where Date = To_Date('16/06/2025','DD/MM/YYYY')
),
